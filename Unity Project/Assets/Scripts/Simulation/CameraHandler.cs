...
public class CameraHandler : MonoBehaviour
{
    ...
    private static readonly float[] BoundsX = new float[] { -10000f, 10000f };
    private static readonly float[] BoundsZ = new float[] { -10000f, -10000f };
    [SerializeField]
    ...
    void Awake()
    {
        ...
        PanSpeed = _statePattern.DirPanSpeed;
    }
